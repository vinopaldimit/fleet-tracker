...
//		Truck( mileage,  make,  model,  year,  vIn,  ,  actualRun, milesAtService,  milesBetweenService,  dotInspectionDate)
		...
		createTruckList(new Truck[] {
				new Truck(500000F, "Freightliner", "Cascadia", "2019", "3AKJHJL12345", "EFP123", "Rialto", 400000F,
						50000F, "05/04/2018"),
